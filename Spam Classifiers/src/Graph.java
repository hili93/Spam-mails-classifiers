...
/**
 * The Graph class will create a JPanel and draw given points  while providing interactive viewing of the graph.
 */
...
public class Graph extends JPanel implements MouseListener, MouseMotionListener, MouseWheelListener, ComponentListener {
	 ...
	 * Format: {{x1, y1}, {x2, y2}, ...}
	 * 
	 * @param pointsHam the points to be graphed in the format of {{x1, y1}, {x2, y2}, ...}
	 */
	public void setPoints(float[][] pointsHam) {
		points = pointsHam;
		repaint();
	}
